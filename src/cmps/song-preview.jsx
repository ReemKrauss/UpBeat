...
export const SongPreview = ({ song, onAddFromPlaylist, onSetMiniPlaylist, playerId, provided }) => {
    ...
    const getTime = () => {
        ...
        else return <span className="date flex">{utilService.convertMsToTime(datecurr - (songDate / 1000))}</span>
    }
