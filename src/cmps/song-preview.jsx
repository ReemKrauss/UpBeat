...
export const SongPreview = ({ song, onAddFromPlaylist, onSetMiniPlaylist, playerId }) => {
    ...
    return <section className="song-preview flex">
        <div className="song-container flex">
            <div className='play-container flex'>
                ...
                {isCurrPlaying && isPlaying && <svg role="img" height="16" width="16" className='play-btn hidden' viewBox="0 0 16 16" ><path d="M2.7 1a.7.7 0 00-.7.7v12.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V1.7a.7.7 0 00-.7-.7H2.7zm8 0a.7.7 0 00-.7.7v12.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V1.7a.7.7 0 00-.7-.7h-2.6z"></path></svg>}
            </div>
            <img src={song.imgUrl} />
