...
export const SongPreview = ({ song, onAddFromPlaylist, onSetMiniPlaylist }) => {
    ...
    //     if(!isShuffled && miniPlaylist.songs[miniPlaylist.currSongIdx.idx] === song.idx){
            
    //     }
    // }

    console.log(miniPlaylist.currSongIdx, song.idx, song.title)
